...
#export CUDA_VISIBLE_DEVICES=3; python run_cifar10_jax_version.py --alpha 1  --scheme RK4 --n_steps 32 --n_basis 32 --epsilon 32 --seed 1 --save_dir ../rk4_full_cifar10/ --which_model ContinuousReLU

#export CUDA_VISIBLE_DEVICES=3; python run_cifar10_jax_version.py --alpha 1  --scheme Euler --n_steps 32 --n_basis 32 --epsilon 32 --seed 1 --save_dir ../euler_full_cifar10/ --which_model ContinuousReLU
...
parser.add_argument('--which_model', type=str, default="Continuous", help='which model')
