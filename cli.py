...
parser.add_argument('--wd', type=float, default=5e-4, metavar='N', help='weight_decay (default: 5e-4)')
parser.add_argument('--epochs', type=int, default=160, metavar='N', help='number of epochs to train (default: 160)')
parser.add_argument('--batch', type=int, default=128, metavar='N', help='batch size (default: 128)')
