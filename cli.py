...
parser.add_argument('--weight-decay', type=float, default=5e-4, metavar='N', help='weight_decay (default: 5e-4)')
...
parser.add_argument('--lr-decay-epoch', type=int, nargs='+', default=[30, 60, 90], help='decrease learning rate at these epochs')
...
parser.add_argument('--batch-norm', default=True, help='include batch norm layers', action='store_true')
...
def drive_by_args(args):
    driver.do_a_train_set(
        ...
        N_adapt = args.refine,
        lr = args.lr,
        lr_decay = args.lr-decay,
        epoch_update = args.lr-decay-epoch,
