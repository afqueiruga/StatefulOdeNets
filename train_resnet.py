...
#
parser.add_argument('--test_batch_size', type=int, default=256, metavar='N', help='input batch size for testing (default: 1000)')
#
...
#
parser.add_argument('--lr_decay', type=float, default=0.1, help='learning rate ratio')
#
parser.add_argument('--lr_schedule', type=str, default='normal', help='learning rate schedule')
#
...
# get dataset
#==============================================================================
train_loader, test_loader = getData(name=args.name, batch_size=args.batch_size, test_batch_size=args.test_batch_size)
...
for epoch in range(1, args.epochs + 1):
    ...
    total_num = 0
    n_print = 5
    if epoch == 1 or (epoch+1) % n_print == 0:
