...
#
parser.add_argument('--epochs', type=int, default=160, metavar='N', help='number of epochs to train (default: 90)')
#
...
#
parser.add_argument('--lr-decay-epoch', type=int, nargs='+', default=[90,120,150], help='Decrease learning rate at these epochs.')
#
